...
<%
	...
	String qry = "SELECT * FROM TREEVIEW WHERE parentid='0' and sdi='CT' ORDER BY SORTORDER";	
...
function loadChild(id, itemid) {
	$.ajax({
		url: "ajax-cpas/load-child-tv.jsp?sdi=CT&parentid=" + itemid,
...
<td>
<span style="font-family: Arial; font-size:18px;"><span style="background-color:black; color: white;">C</span><span style="background-color:#FF9900; color: white;">PAS</span> <span style="color: blue; font-family: Arial; font-size:18px; font-weight:bold;">Tools</span></span>
</td>
