...
//	String qry = "SELECT SYNONYM_NAME, TABLE_OWNER, TABLE_NAME, (SELECT NUM_ROWS FROM ALL_TABLES WHERE OWNER=A.TABLE_OWNER AND TABLE_NAME =A.TABLE_NAME) NUM_ROWS FROM USER_SYNONYMS A ORDER BY 1"; 	
	String qry = "SELECT SYNONYM_NAME, TABLE_OWNER, TABLE_NAME, (SELECT NUM_ROWS FROM ALL_TABLES WHERE OWNER=A.TABLE_OWNER AND TABLE_NAME =A.TABLE_NAME) NUM_ROWS FROM ALL_SYNONYMS A WHERE OWNER='"  + schema + "' ORDER BY 1"; 	
